...
<head>
    ...
    <script>
        function getdid(date,shiftTime,departmentId) {
...
<form id="FORM" name="FORM" hidden="hidden" action="${pageContext.request.contextPath}/needlogin/DepartmentAppointAdd" method="post">
    <input type="text" id="date" name="date" value="2024-07-15">
    <input type="text" id="shiftTime" name="shiftTime" value="上午">
    <input type="text" id="departmentId" name="departmentId" value="1">
</form>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="section-title">
                    <!-- section title start-->
                    <h1>${departments.departmentName}</h1>
                    <p class="lead">${departments.departmentDescription}</p>
                </div>
                <!-- /.section title start-->
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt10">
                <h3>   We have dedicated to settle for nothing <br>less than
                    the BEST.</h3>
                <p>Cras vulputate, neque et cursuor arcu feugiat elitin suscipit dolor urna commodo mauris. Ut sempersuadaras non tellus.</p>
                <div class="about-list mb40 ">
                    <ul class="angle angle-right">
                        <li>The facilities comprise of the most updated and innovative technologies to provide the most advanced treatment.</li>
            ...
            <tr align="center">
                <c:forEach items="${doctorSchedules}" var="d">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <td><button onclick="getdid('${d.date}','${d.shiftTime}','${d.departmentId}')" style="background-color: #25aae1;color: white">剩余${d.visitCount}<br>预约</button></td>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
            </tr>
