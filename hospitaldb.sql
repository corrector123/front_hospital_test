...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='这是管理员信息表';

-- ----------------------------
-- Records of admins
-- ----------------------------
INSERT INTO `admins` VALUES ('1', 'admin', '12345', '刘磊', 'avatar_admin1.jpg', '13512345678', 'admin@example.com');
...
CREATE TABLE `announcement` (
  ...
  `creation_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '公告创建时间',
  `creator` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '公告创建人',
  PRIMARY KEY (`announcement_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='公告信息表';
...
CREATE TABLE `appointments` (
  ...
  `patient_id` int(11) DEFAULT NULL COMMENT '患者编号',
  `doctor_id` int(11) DEFAULT NULL COMMENT '医生编号',
  `appointment_date` date DEFAULT NULL COMMENT '预约的日期',
  `appointment_time` varchar(500) DEFAULT NULL COMMENT '预约的具体时间',
...
-- ----------------------------
INSERT INTO `appointments` VALUES ('1', '1', '1', '2024-06-27', '上午', 'booked');
INSERT INTO `appointments` VALUES ('2', '2', '2', '2024-06-19', '上午', 'booked');
INSERT INTO `appointments` VALUES ('3', '3', '1', '2024-06-10', '下午', 'cancelled');
INSERT INTO `appointments` VALUES ('4', '7', '1', '2024-07-01', '上午', 'completed');
INSERT INTO `appointments` VALUES ('5', '6', '1', '2024-07-01', '上午', 'completed');
INSERT INTO `appointments` VALUES ('6', '8', '3', '2024-07-01', '下午', 'booked');
INSERT INTO `appointments` VALUES ('7', '8', '1', '2024-07-01', '上午', 'booked');
INSERT INTO `appointments` VALUES ('8', '8', '2', '2024-07-04', '下午', 'booked');
...
CREATE TABLE `consultation` (
  ...
  `patient_id` int(11) DEFAULT NULL COMMENT '患者编号',
  `doctor_id` int(11) DEFAULT NULL COMMENT '医生编号',
  `consultation_time` timestamp NULL DEFAULT NULL COMMENT '就诊时间',
  ...
  KEY `patient_id` (`patient_id`) USING BTREE,
  KEY `doctor_id` (`doctor_id`) USING BTREE,
  CONSTRAINT `consultation_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`),
  CONSTRAINT `consultation_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`doctor_id`)
...
CREATE TABLE `departments` (
  ...
  `department_pid` int(11) DEFAULT NULL COMMENT '上级科室编号',
  `department_level` int(11) DEFAULT NULL COMMENT '科室级别',
  ...
  KEY `department_pid` (`department_pid`) USING BTREE
...
INSERT INTO `departments` VALUES ('31', 'test', '0', '1', null, 'test');
...
CREATE TABLE `doctors` (
  ...
  `department_id` int(11) DEFAULT NULL COMMENT '所属科室的标识符',
  `professional_title_id` int(11) DEFAULT NULL COMMENT '职称的标识符',
  PRIMARY KEY (`doctor_id`) USING BTREE,
  KEY `department_id` (`department_id`) USING BTREE,
  KEY `professional_title_id` (`professional_title_id`) USING BTREE,
  CONSTRAINT `doctors_ibfk_1` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`),
  CONSTRAINT `doctors_ibfk_2` FOREIGN KEY (`professional_title_id`) REFERENCES `professional_titles` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='医生信息表';
...
CREATE TABLE `doctor_schedule` (
  ...
  `doctor_id` int(11) DEFAULT NULL COMMENT '医生的唯一标识符',
  `date` date DEFAULT NULL COMMENT '排班的日期',
  `shift_time` varchar(500) DEFAULT NULL COMMENT '具体的排班时间',
  `department_id` int(11) DEFAULT NULL COMMENT '所属科室的标识符',
  `is_available` tinyint(1) DEFAULT '0' COMMENT '是否可排班0 可排班 1 不可排班',
  `visit_count` int(11) DEFAULT '0' COMMENT '就诊数量',
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注信息',
  PRIMARY KEY (`schedule_id`) USING BTREE,
  KEY `doctor_id` (`doctor_id`) USING BTREE,
  KEY `department_id` (`department_id`) USING BTREE,
  CONSTRAINT `doctor_schedule_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`doctor_id`),
  CONSTRAINT `doctor_schedule_ibfk_2` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='医院医生多天排班表';

-- ----------------------------
-- Records of doctor_schedule
-- ----------------------------
INSERT INTO `doctor_schedule` VALUES ('1', '1', '2024-07-01', '上午', '6', '0', '49', null);
INSERT INTO `doctor_schedule` VALUES ('2', '1', '2024-07-02', '下午', '6', '0', '0', null);
INSERT INTO `doctor_schedule` VALUES ('3', '2', '2024-07-03', '上午', '6', '0', '50', null);
INSERT INTO `doctor_schedule` VALUES ('4', '3', '2024-07-01', '下午', '6', '0', '9', null);
INSERT INTO `doctor_schedule` VALUES ('5', '3', '2024-07-01', '上午', '6', '0', '10', null);
INSERT INTO `doctor_schedule` VALUES ('6', '2', '2024-07-05', '下午', '6', '0', '50', null);
INSERT INTO `doctor_schedule` VALUES ('7', '2', '2024-07-04', '下午', '6', '0', '9', null);
INSERT INTO `doctor_schedule` VALUES ('8', '3', '2024-07-08', '上午', '6', '0', '50', null);
...
CREATE TABLE `hospitalization` (
  ...
  `patient_id` int(11) DEFAULT NULL COMMENT '患者的标识符',
  ...
  KEY `patient_id` (`patient_id`) USING BTREE,
  CONSTRAINT `hospitalization_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='住院信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='患者信息表';
